...
The following points should be noted:
  ...
  1、For large-scale cases (IEE 59/141 system), due to the low solution efficiency of the W matrix, therefore, here we provide a method to accelerate the solution: we adopted dual technology, and the dualization of 
